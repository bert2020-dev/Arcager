...
================================================================================
  ...
  encrypt it with a password, attach media, or hide arbitrary files inside
...
================================================================================
  ...
  arcager produces a single .html file containing:
    ...
    - Optional visible attachments (images, fonts, audio, video,
  ...
  With -a PATH hidden, files are stored as an opaque encrypted blob that
...
================================================================================
  ...
  ── unpack ────────────────────────────────────────────────────────────
      ...
      attachments or hidden payloads — that's what -x is for.
  ...
  ── extract ───────────────────────────────────────────────────────────
      ...
      the payload and/or attachment password as needed, and for
...
================================================================================
  ...
  --attach / -a PATH [hidden] adds files to the bundle.  It can be
  given multiple times.  Visible and hidden attachments can be mixed
  in the same pack.
  ...
  Total uncompressed attachment cap: 128 MB.
  ...
  attachment set, a short alias is added (so 'ge' works when there is
  ...
  When -E is used, visible attachments are encrypted with the payload
  ...
  Hidden attachments use their own password, independent from the
  payload password.  If both -E and -a ... hidden are used, the script
  prompts twice — clearly labelled "Payload password" and "Attachment
  password".

  Because hidden attachments are encrypted with an attachment password
  and can coexist with any pack output, they're useful for exchanging
  secret files between consenting parties: the cover page (if any)
  loads cleanly for anyone, and only those with the attachment password
...
================================================================================
  ...
  -a PATH hidden
      ...
      The hidden attachment blob is encrypted with the attachment
      password.  Prompts for a password unless --attach-password is
      given.
  ...
  Constraints:
    ...
    - Passwords are prompted twice on pack and once on unpack/extract,
      unless --password / --attach-password is given.
...
================================================================================
  ...
  COMPRESSION
    ...
    -m, --minify [lossy]    Minify the unpacker JS (via Terser on PATH)
                            and strip HTML comments from the payload.
                            Add 'lossy' to also collapse inter-tag
                            whitespace and remove sourceMappingURL
                            comments.  Lossy.
...
================================================================================
  ...
  ── EXAMPLE 3: Bundle a page with a folder of flags ──────────────────
      ...
      rewritten to the in-memory attachment.
  ...
  ── EXAMPLE 4: Hide arbitrary files inside a normal-looking page ─────
      ...
      python arcager.py -a secret.zip hidden -a documents/ hidden \
          cover.html

      Produces a plain HTML cover page.  secret.zip and a zipped copy
      of documents/ are encrypted inside the page with an attachment
      password you choose at prompt time.  To recover them:

          pip install cryptography
          python arcager.py -x pack -O ./out packed_cover.html

      You are prompted for the attachment password.  Both are
      recovered: secret.zip as-is, and documents/ as documents.zip
      (folders are zipped at pack time).

  ── EXAMPLE 5: Combine payload and attachment encryption ────────────
      ...
      Three prompts:
        ...
        3. Attachment password (for secret.zip)
      ...
      Recover everything:
          ...
          python arcager.py -x all -O ./out --password PW \
              --attach-password APW packed_page.html
...
================================================================================
  ...
  Notes:
    ...
    - Already-compressed attachments are stored without re-compression.
...
================================================================================
  ...
  "hidden attachments require an attachment password"
      Pass --attach-password or run interactively.
